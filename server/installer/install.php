    ...
    try {
        ...
        try {
            ...
            $confData = '<?php' . "\n"
                ...
                . '    $CMATIC[\'conf\'] = array(' . "\n"
                . '        \'db\' => array(' . "\n"
                . '            \'host\' => \'' . TextUtils::slashForPhpStringLiteral($requestParams['host']) . '\',' . "\n"
                . '            \'port\' => \'' . TextUtils::slashForPhpStringLiteral($requestParams['port']) . '\',' . "\n"
                . '            \'db\' => \'' . TextUtils::slashForPhpStringLiteral($requestParams['db']) . '\',' . "\n"
                . '            \'user\' => \'' . TextUtils::slashForPhpStringLiteral($requestParams['user']) . '\',' . "\n"
                . '            \'password\' => \'' . TextUtils::slashForPhpStringLiteral($passwordPlaceholder) . '\'' . "\n"
                . '        ),' . "\n"
                . '        \'app\' => array(' . "\n"
                . '            \'tablePrefix\' => \'' . TextUtils::slashForPhpStringLiteral($requestParams['tablePrefix']) . '\'' . "\n"
                . '        )' . "\n"
                . '    );' . "\n"
                . '?>' . "\n";
