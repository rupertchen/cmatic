...
$cssInternal = sprintf('%s/%s', WWW_PATH, 'css/internal.css');
$jsGlobal = sprintf('%s/%s', WWW_PATH, 'js/global.js');
$jsFormatting = sprintf('%s/%s', WWW_PATH, 'js/formatting.js');
$jsField = sprintf('%s/%s', WWW_PATH, 'js/fields.js');
?>
