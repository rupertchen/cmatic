<?php
    ...
    if ($isNew) {
        ...
        $p0 = 'INSERT INTO cmat_annual.competitor ('
            . 'cmat_year, first_name, last_name, birthdate, gender_id, level_id, age_group_id, registration_date_id, registration_type_id, submission_format_id'
            . ') VALUES ('
            . "15, '%s', '%s', '%s', %d, %d, %d, %d, %d, %d"
            . ')';
    } else {
        // Update
        $p0 = 'UPDATE cmat_annual.competitor SET'
            . " first_name = '%s', last_name='%s', birthdate='%s', gender_id=%d, level_id=%d, age_group_id=%d, registration_date_id=%d, registration_type_id=%d, submission_format_id=%d"
